# Axona AI Grounding — kernel 4.40.0
...
**kernel 4.40.0 / wire 4.0, deployed on testnet (`wss://testnet.axona.net`)**.
...
- The testnet bridge is `wss://testnet.axona.net` (kernel 4.40.0, wire 4.0) —
