...
interoperate. Install \texttt{github:axona-net/axona-protocol\#v4.16.1}
...
\tightlist
\item
  \href{Quick-Start-v4.16.1.md}{Quick Start} --- 5-minute working
  roundtrip.
\item
  \href{Axona-Programmer-Guide-v4.16.1.md}{Programmer Guide} --- mental
...
assistant? Hand it the \href{Axona-AI-Grounding-v4.16.1.md}{AI
...
\textbf{Nearest-replica reads (v4.11.1--v4.16.1).} A pull is answered by
...
\textbf{When snapshots arrive.} The timing contract (v4.16.1):
...
\KeywordTok{const}\NormalTok{ transport }\OperatorTok{=} \FunctionTok{webTransport}\NormalTok{(\{}
  ...
  \DataTypeTok{peerVersion}\OperatorTok{:} \StringTok{\textquotesingle{}4.16.1\textquotesingle{}}\OperatorTok{,}                   \CommentTok{// your app version (gated by the bridge)}
...
\NormalTok{KERNEL\_VERSION       }\CommentTok{// \textquotesingle{}4.16.1\textquotesingle{}   — kernel semver (npm release tag)}
...
\item
  \textbf{Nearest-replica reads (v4.11.1--v4.16.1).} \texttt{pull} is
