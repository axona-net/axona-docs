...
\vspace{2em}
{\small Version 0.3.58 \quad Simulator v0.94.0 \quad 2026-05-23\par}
\vfill
\end{fullwidth}
\newpage
...
Applications implement resharing by re-issuing
\texttt{peer.pub} on the upstream signed envelope. The first
role-bearing relay on the notification path sees the duplicate
\texttt{msgId} and bumps \texttt{reshare\_count}, which
\texttt{metrics} surfaces back to the publisher.
