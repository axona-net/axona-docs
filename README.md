...
| [**Services Guide v4.35.0**](programmer-guide/Axona-Services-Guide-v4.35.0.pdf) | For operators: the signaling bridge, the relay and its four front-ends (console, CLI, MCP server, desktop), directory/federation, and the PoW collector — the programs you *run* rather than write. |
