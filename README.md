...
| **[Topic IDs](programmer-guide/Topic-IDs-v3.1.0.md)** · [PDF](programmer-guide/Topic-IDs-v3.1.0.pdf) | You need to address a topic precisely: open vs owned topics, the `{region, owner?, name, write}` descriptor, region as name **or** code, who can publish/subscribe, and how to construct & share a topic ID. Reflects the **current v3.1.0** model. | ~180 lines |
