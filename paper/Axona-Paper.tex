...
($\mathrm{geoBits} = 0$), the neuromorphic chassis still routes
$\sim 39\%$ faster than Kademlia at $25\,000$ nodes purely from
learning (\S\ref{sec:eval-geo}).
...
\midrule
K-DHT & $852$ & $842$ & --- (baseline) \\
\GDHT & $1060$\textsuperscript{$\dagger$} & $826$ & --- (geo is mechanism) \\
\NXseventeen & $523$ & $265$ & $-39\%$ from learning \\
\nhone & $524$ & $260$ & $-39\%$ from learning \\
\axona & $513$ & $272$ & $-40\%$ from learning \\
\bottomrule
...
\texttt{@axona/protocol} v1.1.2 / sim v0.93.0.}
\end{tabular}
\end{table}

The headline: \emph{with no geographic information whatsoever},
the neuromorphic chassis (NX-17 / NH-1 / Axona) routes lookups
$\sim 39$--$40\%$ faster than Kademlia at $25\,000$ nodes ---
purely from LTP-driven path reinforcement. The three
protocols converge within RNG noise on non-churn routing
(they share the same \texttt{AxonaPeer} kernel and produce
identical routing decisions given identical synaptome state).
