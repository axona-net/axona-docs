...
($\mathrm{geoBits} = 0$), \axona still routes $43\%$ faster than
Kademlia at $25\,000$ nodes purely from learning (\S\ref{sec:eval-geo}).
...
\midrule
K-DHT & $852$ & $845$ & --- (baseline) \\
\GDHT & $1060$\textsuperscript{$\dagger$} & $820$ & --- (geo is mechanism) \\
\NXseventeen & $523$ & $270$ & $-39\%$ from learning \\
\nhone & $524$ & $261$ & $-39\%$ from learning \\
\axona & $\mathbf{482}$ & $\mathbf{254}$ & $\mathbf{-43\%}$ from learning \\
\bottomrule
...
\texttt{@axona/protocol} v1.1.2.}
\end{tabular}
\end{table}

The headline: \emph{with no geographic information whatsoever},
\axona routes lookups $43\%$ faster than Kademlia at $25\,000$
nodes; \NXseventeen and \nhone each route $39\%$ faster ---
purely from LTP-driven path reinforcement. Add the S2 prefix
back in and the gap widens further. This is the cleanest
possible ``learning helps'' claim: every confound (bootstrap
