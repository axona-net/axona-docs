...
\vspace{2em}
{\small An Axona Applications Note \quad v0.5 \quad 2026-06-07\par}
\end{center}
\vfill
\null
\newpage
...
browser-native network (\texttt{@axona/protocol} v2.10.0) with an
...
Channel teardown / revoke & \texttt{unsub} / \texttt{kill} (creator delete + tombstone) / \texttt{unpub} \\
...
\texttt{axona/5} handshake plus mesh channel-binding means reports
