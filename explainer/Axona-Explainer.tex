...
\vspace{2em}
{\small An Axona Explainer \quad v0.3.54 \quad 2026-05-21\par}
\end{center}
\vfill
\null
\newpage
...
Axona hits \textbf{$1.25\times$ the floor} at 25{,}000 nodes ($254$ ms vs a $203$ ms $3\delta$ floor at $\delta = 67.8$ ms). NH-1 hits $1.28\times$, NX-17 hits $1.33\times$. All three sit at the theoretical limit. The remaining $\sim$25\% overhead is structural---they take about 4 to 5 hops where an ideal protocol would take 3, and each ``extra'' hop costs about $\delta/2$, exactly as the geometric series predicts.
