...
\vspace{2em}
{\small An Axona Explainer \quad v0.4.11 \quad 2026-05-22\par}
\end{center}
\vfill
\null
\newpage
...
% Rendered as a marginfigure (Tufte idiom) so it sits in the margin
% column next to the S2 discussion without competing with the
% Hilbert-curve Figure 1 below for main-column float space.
\begin{marginfigure}
\centering
...
% Switched from figure* to figure so the caption renders in the
% margin column (Tufte idiom).  This eliminates the long-caption
% wrapping bug that produced overlapping lines under figure*'s
% inline-caption treatment in v0.4.09–v0.4.10.
\begin{figure}[h]
\centering
