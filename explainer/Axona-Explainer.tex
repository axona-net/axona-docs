...
\vspace{2em}
{\small An Axona Explainer \quad v0.4.09 \quad 2026-05-22\par}
\end{center}
\vfill
\null
\newpage
...
\begin{figure*}[h]
\centering
\includegraphics[width=0.9\linewidth]{../images/S2-Map.png}
...
\subsection*{Step 2 --- Iterate protocols against the grid}
...
Nine weeks later, by mid-May, we had measured \textbf{47 distinct DHT designs}:
...
\subsection*{Step 3 --- What promotion and retirement looked like}
...
\subsection*{Step 4 --- Unbinding the protocol from the simulator}
...
\subsection*{Step 5 --- The fixed-grid claim, in retrospect}
