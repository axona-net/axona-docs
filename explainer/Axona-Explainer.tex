...
\vspace{2em}
{\small An Axona Explainer \quad v0.4.27 \quad 2026-05-30\par}
\end{center}
\vfill
\null
\newpage
...
Of course a user can choose to associate themselves with any location in the world. This very rough location is a kind of area code---but the address it is attached to is provably yours, independent of where you actually are, because the address is derived from your cryptographic key and proven the moment you connect. The section \emph{Identity You Can't Fake}, after the pub/sub discussion, explains exactly how.
...
% =====================================================================
\section{Identity You Can't Fake}
