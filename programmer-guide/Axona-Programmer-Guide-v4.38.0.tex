...
\vspace{2em}
{\small The Axona Programmer Guide \quad v4.38.0 \quad 2026-07-23\par}
\end{center}
\vfill
\null
\newpage
...
\textbf{Build apps that have no server.} \emph{(kernel 4.38.0 ·
testnet)}
...
\tightlist
\item
  \href{Quick-Start-v4.38.0.md}{Quick Start} --- a working roundtrip in
...
\item
  \href{Axona-Services-Guide-v4.38.0.md}{Services Guide} --- running
...
If you haven't run the \href{Quick-Start-v4.38.0.md}{Quick Start}, do it
...
\item
  ...
  \href{Axona-Services-Guide-v4.38.0.md}{Services Guide} is yours; not
  before.
\end{itemize}
...
\href{Axona-API-Reference-v4.38.0.md}{API Reference}, it didn't survive
v3 --- the reference is the source of truth.

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\emph{Axona Programmer Guide · kernel 4.38.0 · testnet · 2026-07-23}
