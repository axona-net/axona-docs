...
\vspace{2em}
{\small The Axona Services Guide \quad v4.38.0 \quad 2026-07-23\par}
\end{center}
\vfill
\null
\newpage
...
\emph{(kernel 4.38.0 · testnet --- versioned with the protocol it
...
\item
  ...
  \tightlist
  \item
    \href{Quick-Start-v4.38.0.md}{Quick Start} ·
    \href{Axona-Programmer-Guide-v4.38.0.md}{Programmer Guide} ·
    \href{Axona-API-Reference-v4.38.0.md}{API Reference} --- the
    library.
  \item
...
\ExtensionTok{curl}\NormalTok{ https://bridge.example.net/healthz     }\CommentTok{\# → \{"status":"ok","version":…,"kernelVersion":"4.38.0"\}}
\end{Highlighting}
\end{Shaded}
...
\texttt{axona-relay\ v0.67.0\ {[}EPHEMERAL{]}\ (kernel\ v4.38.0)} ---
...
\tightlist
\item
  \textbf{\href{Axona-Programmer-Guide-v4.38.0.md}{Programmer Guide}}
  --- build the peer that talks to these services.
\item
  \textbf{\href{Axona-API-Reference-v4.38.0.md}{API Reference}} ---
