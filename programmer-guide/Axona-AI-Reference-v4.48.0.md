# Axona AI Reference — kernel 4.48.0
...
- **Tier 1 — [AI Grounding](Axona-AI-Grounding-v4.48.0.md)** (~440 lines):
...
Target network: **kernel 4.48.0 / wire 4.0**. Install
`github:axona-net/axona-protocol#v4.48.0`. If your bridge rejects you with
...
- **4.31.0–4.48.0** — reliability hardening, all **behavioral (no API
  ...
  socket closes (4.48.0, current testnet).
...
*Tier 1 companion: [Axona-AI-Grounding-v4.48.0.md](Axona-AI-Grounding-v4.48.0.md)
