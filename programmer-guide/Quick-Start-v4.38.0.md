...
`@axona/protocol` **v4.38.0** API (kernel 4.38.0). One Node process connects
...
> (`wss://testnet.axona.net`) tracks the newest release — 4.38.0, which this
...
- [API Reference](Axona-API-Reference-v4.38.0.md) — every exported symbol.
...
const BRIDGE = 'wss://testnet.axona.net';           // live testnet bridge (kernel 4.38.0)
...
| Look up a specific symbol | [API Reference](Axona-API-Reference-v4.38.0.md) |
...
bridge runs kernel 4.38.0 (wire 4.0); install
`github:axona-net/axona-protocol#v4.38.0`. Production runs the same wire-4 line
