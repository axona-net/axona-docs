...
\vspace{2em}
{\small The Axona Services Guide \quad v4.35.0 \quad 2026-07-22\par}
\end{center}
\vfill
\null
\newpage
...
\emph{(kernel 4.35.0 · testnet --- versioned with the protocol it
describes; revised 2026-07-22 with the one-command relay-fleet launcher
...
\item
  ...
  \tightlist
  \item
    \href{Quick-Start-v4.27.1.md}{Quick Start} ·
    \href{Axona-Programmer-Guide-v4.27.1.md}{Programmer Guide} ·
    \href{Axona-API-Reference-v4.27.1.md}{API Reference} --- the
    library.
  \item
...
\ExtensionTok{curl}\NormalTok{ https://bridge.example.net/healthz     }\CommentTok{\# → \{"status":"ok","version":…,"kernelVersion":"4.27.1"\}}
\end{Highlighting}
\end{Shaded}
...
\texttt{axona-relay\ v0.67.0\ {[}EPHEMERAL{]}\ (kernel\ v4.35.0)} ---
...
\tightlist
\item
  \textbf{\href{Axona-Programmer-Guide-v4.27.1.md}{Programmer Guide}}
  --- build the peer that talks to these services.
\item
  \textbf{\href{Axona-API-Reference-v4.27.1.md}{API Reference}} ---
