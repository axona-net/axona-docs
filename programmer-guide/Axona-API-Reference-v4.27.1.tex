...
\vspace{2em}
{\small The Axona API Reference \quad v4.27.1 \quad 2026-07-17\par}
\end{center}
\vfill
\null
\newpage
...
kernel --- v4.27.1, the version this reference describes.
...
Install \texttt{github:axona-net/axona-protocol\#v4.27.1}.
\end{quote}
...
\tightlist
\item
  \href{Quick-Start-v4.27.1.md}{Quick Start} --- 5-minute working
  roundtrip.
\item
  \href{Axona-Programmer-Guide-v4.27.1.md}{Programmer Guide} --- mental
...
assistant? Hand it the \href{Axona-AI-Grounding-v4.27.1.md}{AI
...
\KeywordTok{const}\NormalTok{ transport }\OperatorTok{=} \FunctionTok{webTransport}\NormalTok{(\{}
  ...
  \DataTypeTok{peerVersion}\OperatorTok{:} \StringTok{\textquotesingle{}4.27.1\textquotesingle{}}\OperatorTok{,}                   \CommentTok{// your app version (gated by the bridge)}
...
\NormalTok{KERNEL\_VERSION       }\CommentTok{// \textquotesingle{}4.27.1\textquotesingle{}   — kernel semver (npm release tag)}
