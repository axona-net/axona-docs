...
[Programmer Guide](Axona-Programmer-Guide-v2.8.0.md) for the full picture
and the [API Reference](API-Reference-v2.8.0.md) for every exported symbol.
...
| Want to… | Read |
|---|---|
| Understand the mental model | [Programmer Guide §3](Axona-Programmer-Guide-v2.8.0.md#3-mental-model) |
| Build a chat / forum / feed app | [Programmer Guide §12](Axona-Programmer-Guide-v2.8.0.md#12-worked-example-a-regional-chat-app) |
...
| Look up a specific function | [API Reference](API-Reference-v2.8.0.md) |
| Run a bridge locally | [Programmer Guide §11](Axona-Programmer-Guide-v2.8.0.md#11-the-bridge) |
