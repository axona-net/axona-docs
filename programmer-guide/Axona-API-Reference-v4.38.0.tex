...
\vspace{2em}
{\small The Axona API Reference \quad v4.38.0 \quad 2026-07-23\par}
\end{center}
\vfill
\null
\newpage
...
kernel --- v4.38.0, the version this reference describes.
...
Install \texttt{github:axona-net/axona-protocol\#v4.38.0}.
\end{quote}
...
\tightlist
\item
  \href{Quick-Start-v4.38.0.md}{Quick Start} --- 5-minute working
  roundtrip.
\item
...
assistant? Hand it the \href{Axona-AI-Grounding-v4.30.0.md}{AI
...
\KeywordTok{const}\NormalTok{ transport }\OperatorTok{=} \FunctionTok{webTransport}\NormalTok{(\{}
  ...
  \DataTypeTok{peerVersion}\OperatorTok{:} \StringTok{\textquotesingle{}4.38.0\textquotesingle{}}\OperatorTok{,}                   \CommentTok{// your app version (gated by the bridge)}
...
\NormalTok{KERNEL\_VERSION       }\CommentTok{// \textquotesingle{}4.38.0\textquotesingle{}   — kernel semver (npm release tag)}
