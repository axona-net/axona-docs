...
\emph{(kernel 4.11.2 · testnet --- versioned with the protocol it
describes)}
...
\item
  ...
  \tightlist
  \item
    \href{Quick-Start-v4.11.2.md}{Quick Start} ·
    \href{Axona-Programmer-Guide-v4.11.2.md}{Programmer Guide} ·
    \href{Axona-API-Reference-v4.11.2.md}{API Reference} --- the
    library.
  \item
...
\ExtensionTok{curl}\NormalTok{ https://bridge.example.net/healthz     }\CommentTok{\# → \{"status":"ok","version":…,"kernelVersion":"4.11.2"\}}
\end{Highlighting}
\end{Shaded}
...
\texttt{testnet} (\texttt{testnet.axona.net}, \textbf{4.x}). A v4.11.2
...
targets \textbf{production} (the 3.x line); a v4.11.2 MCP peer must set
...
\tightlist
\item
  \textbf{\href{Axona-Programmer-Guide-v4.11.2.md}{Programmer Guide}}
  --- build the peer that talks to these services.
\item
  \textbf{\href{Axona-API-Reference-v4.11.2.md}{API Reference}} ---
