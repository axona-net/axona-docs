...
\vspace{2em}
{\small The Axona Services Guide \quad v4.27.1 \quad 2026-07-17\par}
\end{center}
\vfill
\null
\newpage
...
\emph{(kernel 4.27.1 · testnet --- versioned with the protocol it
describes; revised 2026-07-20 with an AI-agent launch procedure for the
MCP server, §4b)}
