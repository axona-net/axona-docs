...
[Programmer Guide](Axona-Programmer-Guide.md) for the full picture
and the [API Reference](API-Reference.md) for every exported symbol.
...
| Want to… | Read |
|---|---|
| Understand the mental model | [Programmer Guide §3](Axona-Programmer-Guide.md#3-mental-model) |
| Build a chat / forum / feed app | [Programmer Guide §12](Axona-Programmer-Guide.md#12-worked-example-a-regional-chat-app) |
...
| Look up a specific function | [API Reference](API-Reference.md) |
| Run a bridge locally | [Programmer Guide §11](Axona-Programmer-Guide.md#11-the-bridge) |
