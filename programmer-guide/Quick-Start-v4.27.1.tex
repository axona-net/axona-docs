...
\vspace{2em}
{\small The Axona Quick Start \quad v4.27.1 \quad 2026-07-17\par}
\end{center}
\vfill
\null
\newpage
...
current \texttt{@axona/protocol} \textbf{v4.27.1} API (kernel 4.27.1).
...
release --- 4.27.1, which this Quick Start pins --- and
...
\tightlist
\item
  \href{Axona-Programmer-Guide-v4.27.1.md}{Programmer Guide} --- the
...
\KeywordTok{const}\NormalTok{ BRIDGE }\OperatorTok{=} \StringTok{\textquotesingle{}wss://testnet.axona.net\textquotesingle{}}\OperatorTok{;}           \CommentTok{// live testnet bridge (kernel 4.27.1)}
...
Look up a specific symbol & \href{Axona-API-Reference-v4.27.1.md}{API
Reference} \\
\end{longtable}
}
...
mismatch. The testnet bridge runs kernel 4.27.1 (wire 4.0); install
\texttt{github:axona-net/axona-protocol\#v4.27.1}. Production runs the
